...
public class ClosingIndexPanel
  extends Composite
{
 ...
 DateBox startDatePicker = new DateBox();
          ...
          public void onResponseReceived(Request request, Response response) {
            if (200 == response.getStatusCode()) {
              ...
              GWT.log("bad result " + response.getStatusCode());
               ClosingIndexPanel.this.displayError("Couldn't retrieve JSON (" + url + response.getStatusText() + ")");
            }
          }
        });
  ...
  static abstract interface MyBinder
    extends UiBinder<Widget, ClosingIndexPanel>
  {}
}
